Public Class Form1
    ...
    Private Sub LlenarHistorial()
        ...
        My.Computer.Registry.SetValue("HKEY_CURRENT_USER\HistorialCalculadora", "LeyendaHistoria", "Actualizado: " & DateTime.Now.ToString, Microsoft.Win32.RegistryValueKind.String)
