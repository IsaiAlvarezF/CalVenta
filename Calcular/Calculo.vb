Public Class Form1
    ...
    Private Sub LlenarHistorial()
        ...
        My.Computer.Registry.SetValue("HKEY_CURRENT_USER\HistorialCalculadora", "LeyendaHistorial", "Actualizado: " & DateTime.Now.ToString, Microsoft.Win32.RegistryValueKind.String)
    ...
    Private Sub ObtenerHistorial()
        ...
        Me.LeyendaHistorial.Text = My.Computer.Registry.GetValue("HKEY_CURRENT_USER\HistorialCalculadora", "LeyendaHistorial", Nothing)
    ...
    Private Sub LimpiarHistorial_Click(sender As Object, e As EventArgs) Handles LimpiarHistorial.Click
        If MessageBox.Show(Me, "¿Desea borrar el historial?", "Limpiar Historial", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            ...
            My.Computer.Registry.SetValue("HKEY_CURRENT_USER\HistorialCalculadora", "LeyendaHistorial", "Historial vacío...", Microsoft.Win32.RegistryValueKind.String)
            ObtenerHistorial()
        End If
    End Sub
